...
$(document).on('ready', function(){
  ...
  $('h1').on('click', function(){
    console.log('sanity check: title clicked');
    $('img').attr({ src: "/assets/rewatchable-71b134358af9fc43c587db013c58a2a830d92287ee9d91fd5f926f246261bae5.jpg" });
  });
});
$(document).on('ready', function(){

  $('body').append('<span data-line-number="1. ">Roses are red,</span><br>');

});
$(document).on('ready', function(){

  $('body').append('<span data-line-number="2. ">Violets are blue,</span><br>');
